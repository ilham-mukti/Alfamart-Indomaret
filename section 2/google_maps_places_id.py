			...
			for result in results:
				for type in result['types']:
					...
					if(type=='administrative_area_level_2'):
						...
						my_dict.append({'place_id': place_id, 'nama_kelurahan': nama_kelurahan, 'nama_kecamatan': nama_kecamatan, 'nama_kota': nama_kota})
...
path_file_input = 'D:/Yok Belajar/Analisis/Alfamart - Indomaret/data_full_completed_Indomaret.csv'
